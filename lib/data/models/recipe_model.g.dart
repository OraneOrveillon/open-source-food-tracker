...
Recipe _recipeDeserialize(
  ...
  object.deleted = reader.readBoolOrNull(offsets[1]);
...
extension RecipeQueryFilter on QueryBuilder<Recipe, Recipe, QFilterCondition> {
  ...
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> deletedIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'deleted',
      ));
  ...
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> deletedIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'deleted',
      ));
