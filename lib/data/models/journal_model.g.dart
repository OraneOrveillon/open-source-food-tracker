...
extension JournalQueryFilter
  ...
  QueryBuilder<Journal, Journal, QAfterFilterCondition> dateIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Journal, Journal, QAfterFilterCondition> dateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension JournalQueryLinks
    on QueryBuilder<Journal, Journal, QFilterCondition> {
  QueryBuilder<Journal, Journal, QAfterFilterCondition> meals(
      FilterQuery<Meal> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Journal, Journal, QAfterFilterCondition> mealsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Journal, Journal, QAfterFilterCondition> mealsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'meals', 0, true, 0, true);
    });
  }

  QueryBuilder<Journal, Journal, QAfterFilterCondition> mealsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'meals', 0, false, 999999, true);
    });
  }

  QueryBuilder<Journal, Journal, QAfterFilterCondition> mealsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Journal, Journal, QAfterFilterCondition> mealsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Journal, Journal, QAfterFilterCondition> mealsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
