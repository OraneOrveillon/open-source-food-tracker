...
extension WeighingQueryWhereSort on QueryBuilder<Weighing, Weighing, QWhere> {
  ...
  QueryBuilder<Weighing, Weighing, QAfterWhere> anyDate() {
    return QueryBuilder.apply(this, (query) {
...
extension WeighingQueryWhere on QueryBuilder<Weighing, Weighing, QWhereClause> {
  ...
  QueryBuilder<Weighing, Weighing, QAfterWhereClause> dateIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Weighing, Weighing, QAfterWhereClause> dateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Weighing, Weighing, QAfterWhereClause> dateEqualTo(
      DateTime? date) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'date',
  ...
  QueryBuilder<Weighing, Weighing, QAfterWhereClause> dateNotEqualTo(
      DateTime? date) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Weighing, Weighing, QAfterWhereClause> dateGreaterThan(
    DateTime? date, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Weighing, Weighing, QAfterWhereClause> dateLessThan(
    DateTime? date, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Weighing, Weighing, QAfterWhereClause> dateBetween(
    DateTime? lowerDate,
    DateTime? upperDate, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension WeighingQueryFilter
  ...
  QueryBuilder<Weighing, Weighing, QAfterFilterCondition> dateIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Weighing, Weighing, QAfterFilterCondition> dateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Weighing, Weighing, QAfterFilterCondition> valueIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'value',
      ));
  ...
  QueryBuilder<Weighing, Weighing, QAfterFilterCondition> valueIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'value',
      ));
  ...
  QueryBuilder<Weighing, Weighing, QAfterFilterCondition> valueEqualTo(
    double? value, {
  ...
  QueryBuilder<Weighing, Weighing, QAfterFilterCondition> valueGreaterThan(
    double? value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Weighing, Weighing, QAfterFilterCondition> valueLessThan(
    double? value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Weighing, Weighing, QAfterFilterCondition> valueBetween(
    double? lower,
    double? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension WeighingQuerySortBy on QueryBuilder<Weighing, Weighing, QSortBy> {
  ...
  QueryBuilder<Weighing, Weighing, QAfterSortBy> sortByValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'value', Sort.asc);
    });
  }

  QueryBuilder<Weighing, Weighing, QAfterSortBy> sortByValueDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension WeighingQuerySortThenBy
  ...
  QueryBuilder<Weighing, Weighing, QAfterSortBy> thenByValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'value', Sort.asc);
    });
  }

  QueryBuilder<Weighing, Weighing, QAfterSortBy> thenByValueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'value', Sort.desc);
    });
  }
...
extension WeighingQueryWhereDistinct
  ...
  QueryBuilder<Weighing, Weighing, QDistinct> distinctByValue() {
    return QueryBuilder.apply(this, (query) {
...
extension WeighingQueryProperty
  ...
  QueryBuilder<Weighing, double?, QQueryOperations> valueProperty() {
    return QueryBuilder.apply(this, (query) {
